...
/* 
 *  1. Remove the padding so developers are not caught out when they zero out 'fieldset' elements
 *     in all browsers. 
 *  2. Correct the inability to style clickable types in iOS and Safari.
 *  3. Add the correct display in Chrome and Safari. 
*/
legend {
  padding: 0;
} /* 1 */
